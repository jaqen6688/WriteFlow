...
| 平台 | 文件 | 说明 |
|------|------|------|
| Windows | `WriteFlow Setup x.x.x.exe` | 双击安装即可 |
| macOS (Apple Silicon) | `WriteFlow-x.x.x-arm64.dmg` | M1/M2/M3/M4 芯片的 Mac |
...
| Platform | File | Notes |
|----------|------|-------|
| Windows | `WriteFlow Setup x.x.x.exe` | Double-click to install |
